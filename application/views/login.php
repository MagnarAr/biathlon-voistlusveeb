<html>
<head>
    <title>Login with Facebook | Biathlon Võistlusveeb</title>
...
<body>
    ...
    <div class="container">
        ...
        <form class="form-signin" role="form">
            <?php if (@$user_profile):  // call var_dump($user_profile) to view all data
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <a href="http://facebook.com/<?=$user_profile['id']?>" class="btn btn-lg btn-default btn-block" role="button">View Profile</a>
                        <a href="<?= $logout_url ?>" class="btn btn-lg btn-primary btn-block" role="button">Logout</a>
                    </div>
                </div>
            <?php else: ?>
                <h2 class="form-signin-heading">Logi sisse Facebooki kaudu</h2>
            ...
            <div class="footer">
                <p><a href='http://biathlon.cs.ut.ee/' target="_blank" title="Biathlon Võistlusveeb">Biathlon Võistlusveeb</a>.</p>
            </div>
        </form>
